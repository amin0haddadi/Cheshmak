...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      {
        question: "چگونه فریم مناسب صورت خود را پیدا کنم؟",
        answer:
          "در صفحه فروشگاه می‌توانید بر اساس شکل فریم، جنسیت و سبک فیلتر کنید. اگر مطمئن نیستید، تیم پشتیبانی چشمک راهنمایی‌تان می‌کند.",
      },
      {
        question: "آیا لنز طبی هم دارید؟",
        answer:
          "مجموعه ما شامل عینک طبی، آفتابی و فریم است. جزئیات هر مدل در صفحه محصول آمده است.",
      },
      {
        question: "آیا می‌توانم عینک را تعویض کنم اگر اندازه نباشد؟",
        answer:
          "بله. طبق سیاست مرجوعی ۳۰ روزه، اگر مدل مناسب نبود می‌توانید تعویض یا مرجوعی ثبت کنید.",
      },
    ],
  },
  {
