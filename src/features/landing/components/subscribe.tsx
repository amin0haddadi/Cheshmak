...
export function Subscribe() {
  ...
  return (
    <section className='relative overflow-hidden py-16 lg:py-24'>
      {/* Decorative cutout — glasses without background */}
      ...
      <div className='container-custom relative z-10'>
        <div className='mx-auto max-w-2xl text-center'>
          ...
          <form
            ...
            className='mx-auto flex max-w-md flex-col gap-4 sm:flex-row-reverse'
          >
            <Input
              type='email'
          ...
          <p className='mt-4 text-xs text-muted-foreground'>
            با عضویت، شما با سیاست حریم خصوصی ما موافقت کرده و رضایت می‌دهید که
            از چشمک به‌روزرسانی دریافت کنید.
          </p>
        </div>
      </div>
    </section>
